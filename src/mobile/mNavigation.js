...
class mNavigation extends Component {
  ...
  musicButtonBuilder() {
    let musicClass = 'mmusicbutton'; //navigation.css
    if (music) {
      musicClass += ' mmusicbutton-active';
    }
  ...
  secondaryBuilder() {
    return (
      <div>
        <p className={'mdescription'}>a bench in the castle grounds <br/>of bratislava castle</p>
        <div
